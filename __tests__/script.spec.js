...
describe('Tests for script.js', () => {
    beforeEach(() => {
        // Réinitialiser les pièges et bonus avant chaque test
        script.calculerPiegesBonus();
    });

    test('calculerPiegesBonus génère des pièges et bonus', () => {
        // On appelle à nouveau la fonction pour obtenir les valeurs après qu'elles aient été réinitialisées
